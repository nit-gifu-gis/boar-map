...
class BoarInfo extends React.Component {
  render() {
    ...
    if (this.props.detail["properties"]["罠・発見場所"] === "箱わな") {
      ...
      return <div className="boar-info">TODO: To be implemented.</div>;
    } else {
      console.log(this.props.detail["properties"]["捕獲いのしし情報"][0]);
      return (
        <div className="boar-info">
          ...
          <InfoDiv
            title="幼獣・成獣の別"
            data={
              this.props.detail["properties"]["捕獲いのしし情報"][0][
                "成獣幼獣別"
              ]
            }
          />
          <InfoDiv
            ...
            type="text"
            data={
              this.props.detail["properties"]["捕獲いのしし情報"][0]["性別"]
            }
          />
          <InfoDiv
            title="体長"
            type="number"
            data={
              this.props.detail["properties"]["捕獲いのしし情報"][0]["体長"]
            }
            unit="cm"
          />
          <InfoDiv
            ...
            type="number"
            data={
              this.props.detail["properties"]["捕獲いのしし情報"][0]["体重"]
            }
            unit="kg"
          />
          {pregnantInfo}
          <InfoDiv
            ...
            type="text"
            data={
              this.props.detail["properties"]["捕獲いのしし情報"][0]["処分方法"]
            }
          />
          <InfoDiv
            title="備考（遠沈管番号）（作業時間）"
            type="longText"
            data={
              this.props.detail["properties"]["捕獲いのしし情報"][0]["備考"]
            }
          />
        </div>
      );
