...
- メニューにお知らせへのリンクを追加しました。
- 豚熱陽性確認情報の県番号が文字列で入力可能になりました。
- ワクチンメッシュの図面がダウンロードできるようになりました。
- 豚熱感染高率エリアの表示期間・範囲が変更できるようになりました。
- お知らせが更新された時、次回ログイン時に通知されるようになりました。
- 一覧表を開いたときに直近に登録した5件の情報が表示されるようになりました。


### Version 2.5.0

- わなアイコンの種類を追加しました。
- 歯列画像を2枚まで追加できるようになりました。
- 作業日報の入力項目を変更しました。
- 作業日報AをPDFファイルとして出力できるようになりました。
- メッシュ番号表示のデザインを調整しました。


### Version 2.4.2

- 情報が正常に検索されない問題を修正しました。
...
- 連絡先に関する情報を更新しました。
- 表示されるメッセージを更新しました。
- 写真をクリックすると画像ファイルが別ウィンドウで表示されるようにしました。


### Version 2.4.0

- 入力項目を追加しました。
- ベースマップに目標物が表示されるレイヤーを追加しました。
- 備考欄の項目を変更できるようにしました。
- レイヤー設定の枠が非表示になるように変更しました。
- 複数個体登録時に個体管理番号が正常に付与されない問題を修正しました。
- 検体到着日で一覧表を出力できるようにしました。
