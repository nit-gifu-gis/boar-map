...
- Version 1.2.0以前で入力した情報を編集できるように変更しました。
- ジビエ業者渡しの際の地域の選択を農林事務所単位から圏域単位に変更しました。
- 捕獲情報の「備考（遠沈管番号）（作業時間）」を「備考（遠沈管番号）」に変更しました。
- 個体管理番号の表記からハイフンを削除しました。
- 個体管理番号を付与した物のみに確認番号が表示されるように変更しました。
- 個体管理番号の処理年を年度に変更しました。
- 処分方法のリストの内容を変更しました。
...
- わなの種類に銃猟を追加しました。
- わなの種類が箱わな/囲いわな/銃猟の時に複数体の情報を入力できるように変更しました。
- 履歴管理システムを実装しました。
