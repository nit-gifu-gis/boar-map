      ...
      <table className="block border-collapse whitespace-pre">
        <tbody className="table">
          <tr>
            ...
            <th
              className={"border-solid border p-1 border-border border-b-2 " + sortableClass("罠の種類")}
              onClick={() => sort("罠の種類")}
            >
              罠の種類
            </th>
            <th
              className={"border-solid border p-1 border-border border-b-2 " + sortableClass("設置年月日")}
              onClick={() => sort("設置年月日")}
            >
              設置
              <br />
            ...
            <th 
              className={"border-solid border p-1 border-border border-b-2 " + sortableClass("撤去年月日")}
              onClick={() => sort("撤去年月日")}
            >
              撤去
              <br />
