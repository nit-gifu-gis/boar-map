...
const ReportInfoView: React.FunctionComponent<ReportInfoViewProps> = ({ detail, confirmMode }) => {
  ...
  return reportBValue != undefined ? (
    <div className='box-border w-full'>
      ...
      <InfoDiv
        title='作業報告B'
        type='workB'
        data={[reportBValue, detail.properties.捕獲補助, parsedToolValue]}
      />
