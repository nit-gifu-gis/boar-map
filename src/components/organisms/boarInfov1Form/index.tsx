      ...
      <div className='w-full'>
        <form id='form-boar-old' onSubmit={(e) => e.preventDefault()}>
          ...
          <InfoInput
            ...
            options={['幼獣', '成獣']}
            defaultValue={
              featureValueOrUndefined('幼獣・成獣') === undefined
                ? '幼獣'
                : featureValueOrUndefined('幼獣・成獣')
            }
          ...
          <InfoInput
            ...
            options={['オス', 'メス', '不明']}
            defaultValue={
              featureValueOrUndefined('性別') === undefined
                ? '不明'
                : featureValueOrUndefined('性別')
            }
          ...
          <InfoInput
            ...
            defaultValue={
              featureValueOrUndefined('処分方法') === undefined
                ? '埋設'
