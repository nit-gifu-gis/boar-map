...
const DateInput: React.FunctionComponent<DateInputProps> = (props) => {
  ...
  const onChangeValueForSafari = () => {
    const yearValue = (
      document.getElementById(props.id + "Year") as HTMLInputElement
    ).value;
    const monthValue = (
      document.getElementById(props.id + "Month") as HTMLInputElement
    ).value;
    const dayValue = (
      document.getElementById(props.id + "Day") as HTMLInputElement
    ).value;
  ...
  const initForm = () => {
    ...
    if (props.required) {
      ...
      setDate(yearValue, monthValue, dayValue);
      if (isSafari) {
        (document.getElementById(props.id + "Year") as HTMLInputElement).value =
          yearValue;
        (
          document.getElementById(props.id + "Month") as HTMLInputElement
        ).value = monthValue;
        (document.getElementById(props.id + "Day") as HTMLInputElement).value =
          dayValue;
      }
    }
  };
