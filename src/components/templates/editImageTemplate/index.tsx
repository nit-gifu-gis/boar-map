...
const EditImageTemplate: React.FunctionComponent = () => {
  ...
  useEffect(() => {
    ...
    setImageKey(key);
    setFeature(f);
    setNewImageIds((f.properties as Record<string, string>)[key].split(',').filter(e=>e));
  }, []);
          ...
          {type == 'boar-2' ? (
            <div className='box-border w-full px-[15px] py-2'>
              ...
              <ImageInput
                ...
                imageIDs={serverImages != null && serverImages.isDeleteTeethImage ? undefined : [(feature as BoarFeatureV2).properties.歯列写真ID].filter(e=>e)}
          ...
          <div className='box-border w-full px-[15px] py-2'>
            <div className='text-justify text-lg font-bold text-text'>
              ...
              <ImageInput
                ...
                imageIDs={serverImages == null ? (feature.properties as Record<string, string>)[imageKey].split(',').filter(e=>e) : serverImages.newServerImages as string[]}
