...
const PDFViewer: React.FC<PDFViewerInterface> = (props) => {
  return (
    <div className="fixed left-0 top-0 z-[999] flex h-screen w-screen flex-col">
      ...
      <div className="grow bg-background">
        <iframe
          ...
          src={`/static/pdfjs/web/viewer.html?file=${encodeURIComponent(props.url)}`}
          loading="lazy"
        />
      </div>
          ...
          <div className="box-border w-3/4vw p-3vw text-center">
            <Link href={props.url}>
              <a target="_blank" rel="noopener noreferrer">
                <Button color="primary">別ウィンドウで開く</Button>
              </a>
            </Link>
          </div>
        </div>
